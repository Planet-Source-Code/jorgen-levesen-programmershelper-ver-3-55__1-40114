...
'|                                                                 |
'| Program Description : I catalogue this program like an utilitiy |
...
'|                                                                 |
'| If you found any bug, please eMail me!                          |
    ...
    If CtlTbl.Type = "TABLE" Then
      ...
      For Each Col In CtlTbl.Columns
        ...
        If Len(Col.Properties("Jet OLEDB:Column Validation Text").Value) > 0 Then
          sGen = sGen & "      .Columns(""" & Col.Name & """).Properties(""Jet OLEDB:Column Validation Text"").Value = """ & Col.Properties("Jet OLEDB:Column Validation Text").Value & """ & vbCrLf"
        End If
        If Len(Col.Properties("Jet OLEDB:Column Validation Rule").Value) > 0 Then
          sGen = sGen & "      .Columns(""" & Col.Name & """).Properties(""Jet OLEDB:Column Validation Rule"").Value = """ & Col.Properties("Jet OLEDB:Column Validation Rule").Value & """ & vbCrLf"
        End If
        If Not Col.Properties("Jet OLEDB:Compressed UNICODE Strings").Value Then
          sGen = sGen & "      .Columns(""" & Col.Name & """).Properties(""Jet OLEDB:Compressed UNICODE Strings"").Value = " & Col.Properties("Jet OLEDB:Compressed UNICODE Strings").Value & vbCrLf
        End If
        If Col.Properties("Jet OLEDB:Allow Zero Length").Value = True Then
          sGen = sGen & "      .Columns(""" & Col.Name & """).Properties(""Jet OLEDB:Allow Zero Length"").Value = " & Col.Properties("Jet OLEDB:Allow Zero Length").Value & vbCrLf
        End If
